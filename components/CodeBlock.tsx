import { PropsWithChildren, MouseEvent, useCallback, ReactElement } from 'react'

interface CodeBlockProps extends PropsWithChildren {
  title: string
  onCopy?: (e: MouseEvent<SVGSVGElement>) => void
  tooltip?: ReactElement | string
}

const CodeBlock = (props: CodeBlockProps) => {
  const { children, title, tooltip, onCopy } = props

    ...
    <div className="dark:bg-slate-900 bg-white">
      ...
      <main className="flex items-center flex-col">
        <article className="max-w-3xl font-sans dark:text-slate-400 text-gray-600 py-20">
          ...
          <h2 className="text-xl mt-2 font-thin">
          ...
          <div className="mt-4 flex items-start">
            <p className="text-md w-2/3 pe-8">
              ...
              instructions teach you how to use Sail and Winter CMS together to
              get up and running.
            </p>
            <aside className="text-sm w-1/3 px-2 py-2 border dark:border-gray-500 rounded-md">
              ...
              instead of{' '}
              <span className="bg-gray-100 font-mono text-sm dark:bg-slate-800">php artisan</span>
              .
            </aside>
          </div>
          ...
          <div className="mt-4 text-sm">
            <div className="bg-gray-100 p-4 rounded-t-md dark:bg-transparent">
              ...
              Replace{' '}
              <span className="bg-gray-200 font-mono text-sm dark:bg-slate-800">example-app</span>{' '}
          ...
          <p className="text-md text-justify mt-4">
            Once everything is ready, you are prompted to run these commands to
          ...
          <p className="text-md mt-4">
            ...
            and run these commands to install Winter CMS. The database settings
            are preconfigured and ready to go.
          </p>
          <div className="mt-4 text-sm">
            <div className="bg-slate-800 text-slate-400 p-1 text-xs rounded-t-md">
              <span>Terminal</span>
